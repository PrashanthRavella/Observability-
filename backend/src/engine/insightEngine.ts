...
function isCircuitOpen(): boolean {
    if (!llmCircuitOpen) return false;
...
export function preAggregateStats(data: any[]) {
...
export async function generateInsight(intent: string, rawData: any[], forceMock = false) {
